...
/**
 * @file
 * Adds a simple icon picker for Material Icons.
 *
 */
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.materialAdminSupportIconPicker = {
    attach: function (context, settings) {
      $('input[type="text"].use-material-icon-picker', context).once('material-icon-picker').each(function () {
